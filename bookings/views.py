...
class AvailableRoomTypes(APIView):
    def get(self, request):
        ...
        check_out = self.request.query_params.get('check_out')
         ...
         # Step 1: Get total room counts
        total_rooms = Room.objects.values(
            'type__id', 'type__name', 'type__price', 'type__description',
            'type__good_for', 'type__max_children', 'type__max_adult'
        ).annotate(total_count=Count('id'))

        # Step 2: Get booked room counts within the given date range
        ...
        # Step 3: Create a dictionary for quick lookup of booked counts
        booked_rooms_dict = {
        ...
        for room in total_rooms:
            ...
            booked_count = booked_rooms_dict.get((room_type_name, room_type_price), 0)
